...
import { ArrowRight, Mail, Lock, User, Compass } from "lucide-react";
  ...
  return (
    <form className="space-y-5" action={signup}>
      ...
      <div className="space-y-2">
        <label className="text-sm font-medium text-traverse-frost/80">Full Name</label>
        <div className="relative">
          ...
          <input 
            ...
            className="w-full py-3 pl-12 pr-4 text-white placeholder-traverse-frost/30 transition-all bg-traverse-midnight/50 border rounded-xl border-traverse-frost/10 focus:border-traverse-aurora focus:outline-none focus:ring-1 focus:ring-traverse-aurora"
          />
        </div>
      </div>
      ...
      <button type="submit" className="w-full flex justify-center items-center py-4 text-white font-bold rounded-xl bg-gradient-main hover:opacity-90 transition-all hover:shadow-[0_0_20px_rgba(124,58,237,0.4)] mt-6">
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-4 pt-20 pb-12 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none -z-10">
        <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-traverse-aurora/10 rounded-full blur-[100px]"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-traverse-cyan/10 rounded-full blur-[100px]"></div>
      </div>
      ...
      >
        <div className="flex justify-center mb-8">
          <div className="p-4 rounded-2xl bg-traverse-ocean/50 border border-traverse-frost/10">
            <Compass className="w-8 h-8 text-traverse-aurora" />
          </div>
        </div>
        
        <h2 className="mb-2 text-3xl font-bold text-center text-white">Join Traverse</h2>
        <p className="mb-8 text-center text-traverse-frost/60">Create your AI travel passport.</p>
        ...
        <p className="mt-8 text-center text-sm text-traverse-frost/60">
          Already have an account? <Link href="/auth/login" className="text-traverse-aurora hover:underline font-medium">Sign in</Link>
        </p>
      </motion.div>
    </div>
  );
